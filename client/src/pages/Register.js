...
export default function Register() {
  return (
    <div className="h-full min-h-screen flex flex-col  bg-indigo-50">
      ...
      <NavLink to='/login' className="mx-auto mt-20 px-6 py-4 md:px-9 md:py-6 rounded-xl bg-indigo-100 hover:bg-indigo-200 border-2 border-indigo-200 text-indigo-800 text-2xl md:text-4xl transition-all duration-300 shadow-2xl hover:shadow-lg">
        <h3>Kom igång</h3>
      </NavLink>
